...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 1559807012;

    /**
     * The reference instance of <code>eds.users</code>
     */
    ...
    /**
     * The column <code>eds.users.name</code>. The name of an user.  unique
     */
    ...
    /**
     * The column <code>eds.users.email</code>.
     */
    ...
    /**
     * The column <code>eds.users.apikey</code>.
     */
    ...
    /**
     * The column <code>eds.users.password</code>. # Password   * Min length: 8   * Max Length : 40   * At least one small capitalized char   * One upper case char   * pattern : ^(?&amp;#x3D;.*\\\\d)(?&amp;#x3D;.*[a-z])(?&amp;#x3D;.*[A-Z]).{8,40}$
     */
    ...
    /**
     * The column <code>eds.users.private_group</code>.
     */
    public final TableField<UsersRecord, String> PRIVATE_GROUP = createField("private_group", org.jooq.impl.SQLDataType.CHAR(30).nullable(false), this, "");

    /**
     * Create a <code>eds.users</code> table reference
     */
    public Users() {
    ...
    /**
     * Create an aliased <code>eds.users</code> table reference
     */
    ...
    public Group group() {
        return new Group(this, Keys.FK_USERS_GROUP1);
    }
