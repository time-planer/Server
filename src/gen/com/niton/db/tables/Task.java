...
public class Task extends TableImpl<TaskRecord> {
    ...
    private static final long serialVersionUID = -709704306;

    /**
     * The reference instance of <code>eds.task</code>
     */
    ...
    /**
     * The column <code>eds.task.name</code>. The name of the Task. needs to be uniqe
     */
    ...
    /**
     * The column <code>eds.task.deadline</code>. The last date where it is totaly needs to be done.
     */
    ...
    /**
     * The column <code>eds.task.planedDate</code>. The date at which you planed to be done with the task
     */
    ...
    /**
     * The column <code>eds.task.description</code>. The description of the task
     */
    ...
    /**
     * The column <code>eds.task.importance</code>. A google playstore like rating. it is from zero to ten. Each point describing a half star. 10 is the best as it is 5 Stars
     */
    ...
    /**
     * The column <code>eds.task.entererAt</code>. The date the taks was created
     */
    ...
    /**
     * The column <code>eds.task.process</code>. How far the task is done in percent
     */
    ...
    /**
     * The column <code>eds.task.group_uid</code>.
     */
    public final TableField<TaskRecord, String> GROUP_UID = createField("group_uid", org.jooq.impl.SQLDataType.CHAR(30).nullable(false), this, "");

    /**
     * The column <code>eds.task.users_email</code>.
     */
    ...
    /**
     * The column <code>eds.task.done</code>.
     */
    ...
    /**
     * Create a <code>eds.task</code> table reference
     */
    public Task() {
    ...
    /**
     * Create an aliased <code>eds.task</code> table reference
     */
    ...
    public List<ForeignKey<TaskRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TaskRecord, ?>>asList(Keys.FK_TASK_GROUP1, Keys.FK_TASK_USERS1);
    }

    public Group group() {
        return new Group(this, Keys.FK_TASK_GROUP1);
    }

    public Users users() {
        return new Users(this, Keys.FK_TASK_USERS1);
    }
