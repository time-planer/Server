...
public class Groupmember extends TableImpl<GroupmemberRecord> {
    ...
    private static final long serialVersionUID = 467861465;

    /**
     * The reference instance of <code>eds.groupmember</code>
     */
    ...
    /**
     * The column <code>eds.groupmember.edit</code>. Is the user permitted to edit tasks within the group
     */
    ...
    /**
     * The column <code>eds.groupmember.create</code>. is the user permitted to create tasks within the Group
     */
    ...
    /**
     * The column <code>eds.groupmember.delete</code>. is the User permitted to delte tasks within the group
     */
    ...
    /**
     * The column <code>eds.groupmember.group</code>.
     */
    public final TableField<GroupmemberRecord, String> GROUP = createField("group", org.jooq.impl.SQLDataType.CHAR(30).nullable(false), this, "");

    /**
     * The column <code>eds.groupmember.user</code>.
     */
    ...
    /**
     * Create a <code>eds.groupmember</code> table reference
     */
    public Groupmember() {
    ...
    /**
     * Create an aliased <code>eds.groupmember</code> table reference
     */
    ...
    public List<ForeignKey<GroupmemberRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<GroupmemberRecord, ?>>asList(Keys.FK_GROUPMEMBER_GROUP1, Keys.FK_GROUPMEMBER_USERS1);
    }

    public Group group() {
        return new Group(this, Keys.FK_GROUPMEMBER_GROUP1);
    }

    public Users users() {
        return new Users(this, Keys.FK_GROUPMEMBER_USERS1);
    }
