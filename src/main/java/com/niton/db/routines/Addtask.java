...
public class Addtask extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = 791083354;

    /**
     * The parameter <code>proj_eds.addTask.tname</code>.
     */
    public static final Parameter<String> TNAME = Internal.createParameter("tname", org.jooq.impl.SQLDataType.VARCHAR(50), false, false);

    /**
     * The parameter <code>proj_eds.addTask.deadline</code>.
     */
    public static final Parameter<Date> DEADLINE = Internal.createParameter("deadline", org.jooq.impl.SQLDataType.DATE, false, false);

    /**
     * The parameter <code>proj_eds.addTask.planeddate</code>.
     */
    ...
    /**
     * The parameter <code>proj_eds.addTask.description</code>.
     */
    ...
    /**
     * The parameter <code>proj_eds.addTask.importance</code>.
     */
    ...
    /**
     * The parameter <code>proj_eds.addTask.groupuid</code>.
     */
     ...
     */
    public Addtask() {
        super("addTask", ProjEds.PROJ_EDS);

        addInParameter(TNAME);
    ...
    /**
     * Set the <code>tname</code> parameter IN value to the routine
     */
    public void setTname(String value) {
        setValue(TNAME, value);
    }
