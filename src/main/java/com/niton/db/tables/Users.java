...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 912218502;
     ...
     */
    public final TableField<UsersRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "The name of an user.  unique");
    ...
    public List<ForeignKey<UsersRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UsersRecord, ?>>asList(Keys.INDENDIFIZIERT, Keys.HATPRIVATEGRUPPE);
    }

    public Apikey apikey() {
        return new Apikey(this, Keys.INDENDIFIZIERT);
    }

    public EdsGroup edsGroup() {
        return new EdsGroup(this, Keys.HATPRIVATEGRUPPE);
    }
